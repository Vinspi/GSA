...
public interface UserService {
   ...
   */
  User registerAccount(String name, String email, String password, String teamName,
      boolean isAdmin);
  ...
  /**
   * This method fetch all product in the database and return a list of all product name.
   * 
  ...
  /**
   * This method fetch all team in the database and return a list of all team name.
   * 
  ...
  /**
   * This method fetch all withdrawals in the period given in argument in the database and return a
   * list of those.
   *
   ...
   */
  List<TransactionData> getUserWithdrawalsHistoryBetween(long userId, LocalDate begin,
      LocalDate end);

  /**
   * This method fetch all withdrawals since the date given in argument in the database and return a
   * list of those.
   *
   * @param userId The user id who make the transaction
   * @param begin The begin of the period to take into account.
  ...
  /**
   * This method fetch all withdrawals up to the date given in argument in the database and return a
   * list of those.
   *
   * @param userId The user id who make the transaction
   * @param end The end of the period to take into account.
  ...
  /**
   * This method fetch all withdrawals in the database and return a list of those.
   *
   * @param userId The user id who make the transaction
   * @return a list of transactions.
   */
  ...
  /**
   * Gets all current and past team reports of a user.
   * 
   * @param userId user calling the endpoint associated to this service
   * @return a list of team reports
   */
  List<TeamReportData> getUserTeamReports(long userId);
