...
import fr.uniamu.ibdm.gsa_server.dao.*;
...
public class AdminServiceImpl implements AdminService {
   ...
   */
  @Autowired
  public AdminServiceImpl(ProductRepository productRepository, TransactionRepository transactionRepository, AliquotRepository aliquotRepository, SpeciesRepository speciesRepository, AlertRepository alertRepository) {
